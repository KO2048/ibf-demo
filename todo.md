...
| NOW-004 | 新增后摄双模式实验页校准追近语义 | engineering | active | P1 | 2026-04-24 | user-feedback | 红蓝对称 / 多点编号采样诊断方案 | Phase 1 | Codex | 2026-04-24 21:32 CST | Codex | 2026-04-24 21:32 CST | 后摄观察窗实验页：双模式同页诊断计划 | `observe-lab-v1` |  |  | 新增独立实验页，先用固定双目标和 8 点采样确认“到底是谁被逼近到了中心”，避免继续在主玩法里猜方向语义 | 该页不带随机飞行、startle、timing、甩动，只做后摄观察语义诊断 |
